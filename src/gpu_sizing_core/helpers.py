...
FORMULA_TERM_LABELS: list[tuple[str, str]] = [
    ...
    ("TPS_pre,p95^cap", "P95 总 Prefill 理论吞吐"),
    ("TPS_pre,bw^card", "Prefill 理论带宽上界"),
    ("TPS_pre,cmp^card", "Prefill 理论算力上界"),
    ("TPS_pre^card", "单卡 Prefill 理论服务率"),
    ("TPS_dec^cap", "总 Decode 理论吞吐"),
    ("TPS_dec,bw^card", "Decode 理论带宽上界"),
    ("TPS_dec,cmp^card", "Decode 理论算力上界"),
    ("TPS_dec^card", "单卡 Decode 理论服务率"),
    ...
    ("Req_day^p95", "理论保守日请求量"),
    ("λ_p95^sus", "理论保守可持续 QPS"),
    ("λ_peak", "峰值 QPS"),
    ("S_in,p95", "P95 输入长度"),
    ("S_out,p95", "P95 输出长度"),
    ("S_p95", "P95 总长度"),
